...
import 'package:spag_notes/widget/color_picker.dart';
import 'package:spag_notes/widget/notes_actions.dart';
...
class _NoteEditorState extends State<NoteEditor> with CommandHandler {
  ...
  List<Widget> _buildTopActions(BuildContext context, String uid) => [
    if (_note.state != NoteState.deleted) IconButton(
        icon: Icon(_note.pinned == true ? Icons.pin_drop_sharp : Icons.pin_drop_outlined),
