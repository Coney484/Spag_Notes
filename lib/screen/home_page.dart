...
import 'package:spag_notes/widget/drawer.dart';
...
//      statusBarColor: Colors.white,
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            const SizedBox(width: 16),
            InkWell(
              child: Icon(_gridView ? Icons.view_list : Icons.grid_on),
              onTap: () => setState(() {
                _gridView = !_gridView;
              }),
            ),
  ...
  Widget _bottomActions() => BottomAppBar(
    ...
    child: Container(
      ...
      child: Row(
        children: <Widget>[
          const Icon(Icons.check_box, size: 26, color: kIconTintLight),
          const SizedBox(width: 30),
          const Icon(Icons.brush_sharp, size: 26, color: kIconTintLight),
          const SizedBox(width: 30),
          const Icon(Icons.mic, size: 26, color: kIconTintLight),
          const SizedBox(width: 30),
          const Icon(Icons.insert_photo, size: 26, color: kIconTintLight),
        ],
      ),
    ),
  );
